...
export default function ManualPage() {
  ...
  const archiveWallet = async (walletId: number) => {
    ...
    const confirmArchive = confirm('Are you sure you want to archive this wallet? It will be hidden but can be restored later.');
    ...
    try {
      ...
      alert('Wallet archived successfully!');
    } catch (error: any) {
      console.error('Failed to archive wallet:', error);
      alert('Failed to archive wallet: ' + (error.message || 'Network error'));
    } finally {
  ...
  const restoreWallet = async (walletId: number) => {
    ...
    try {
      ...
      alert('Failed to restore wallet: ' + (error.message || 'Network error'));
    }
  };
  ...
  const deleteWallet = async (walletId: number) => {
    ...
    const confirmDelete = confirm('Are you sure you want to permanently delete this wallet? This action cannot be undone.');
